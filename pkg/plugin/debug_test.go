...
func TestRunDebug(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			// Set global variables as runDebug uses them
...
func TestGetTargetContainerName(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, err := config.getTargetContainerName()
			if (err != nil) != tt.wantErr {
...
func TestDeletePod(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			err := config.deletePod(tt.podName)
			if (err != nil) != tt.wantErr {
...
func TestAttachToPod(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			err := config.attachToPod(tt.podName)
			if (err != nil) != tt.wantErr {
...
func TestFindExistingDebugPod(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, err := config.findExistingDebugPod()
			if (err != nil) != tt.wantErr {
